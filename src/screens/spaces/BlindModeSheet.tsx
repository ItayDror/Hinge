...
export function BlindModeSheet({ space, post, onClose }: BlindModeSheetProps) {
  ...
  const theirPhoto = portraitCard(person)
      ...
      {state === 'matched' ? (
        <div className="flex flex-col items-center gap-4 py-2 text-center">
          ...
          <p className="text-body text-hinge-grey">
            You and {person.name} showed up for the same thing in {space.title}.
          </p>
        ...
        <div className="flex flex-col items-center gap-4 py-2 text-center">
          <p className="text-[18px] font-bold text-hinge-black">
            You and {initial}. liked each other's posts in {space.title}
          </p>
          <p className="text-body text-hinge-grey">
